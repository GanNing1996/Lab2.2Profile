...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        //requestCode = the unique codwe which identify an intent
        //resulrCode = the result returned by an intent;either OK or not
    ...
    public void showSendTo(View v){
        ...
        intent.setData(Uri.parse("mailto:" + "wongguanfeng1996@gmail.com"));
        startActivity(intent);
    }
}
